...
# with xr.open_dataset('v875Kinematics_t1000_k201_dx025_dt02_field.nc', engine='h5netcdf') as state:
# 	print(state)
...
# 		verbose=2, saveFile='v875Kinematics_t1000_k201_dx025_dt02_eigenvalues.nc',
# 		rootFindingKwargs={},
# 		)

### Print the bound state eigenvalues
eigenvalues = SG.ScatteringData('v875Kinematics_t1000_k201_dx025_dt02_eigenvalues.nc')
print(eigenvalues)

### Plot the kinematics of the solitons produced in the antikink/boundary collision 
eigenvalues.plot_2Dkinematics(axis='k')
plt.title('$v_0=0.875$')
plt.savefig('Kinematics_v875.pdf', bbox_inches='tight')
plt.close()
